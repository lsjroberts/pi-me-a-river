...
Elm.Map.make = function (_elm) {
   ...
   var river = function (river) {
      return function () {
         var toSvgLine = function (line$) {
            return A2($Svg.line,
            _L.fromArray([$Svg$Attributes.x1($Basics.toString(line$.x1))
                         ,$Svg$Attributes.y1($Basics.toString(0 - line$.y1))
                         ,$Svg$Attributes.x2($Basics.toString(line$.x2))
                         ,$Svg$Attributes.y2($Basics.toString(0 - line$.y2))]),
            _L.fromArray([]));
         };
         var toLine = F2(function (c1,
         c2) {
            return {_: {}
                   ,x1: c1.lon
                   ,x2: c2.lon
         ...
         var toLines = function (coords) {
            return $List.map(toSvgLine)(A3($List.map2,
            toLine,
            coords,
            A2($List.drop,1,coords)));
         };
         var toViewBox = function (_v0) {
            return function () {
               return $Utils.join(" ")(_L.fromArray([$Basics.toString(_v0.northEast.lon)
                                                    ,$Basics.toString(0 - _v0.northEast.lat)
                                                    ,$Basics.toString(180)
                                                    ,$Basics.toString(90)]));
            }();
         };
         ...
         _L.fromArray([$Svg$Attributes.version("1.1")
                      ,$Svg$Attributes.x("0")
                      ,$Svg$Attributes.y("0")
                      ,$Svg$Attributes.viewBox(toViewBox(river.bounds))
                      ,$Svg$Attributes.width("100%")
                      ,$Svg$Attributes.height("100")
                      ,$Svg$Attributes.$class("river-map")]),
...
Elm.Model.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var normaliseCoord = function (_v0) {
      return function () {
         return {_: {}
                ,lat: _v0.lat + 90
                ,lon: _v0.lon + 90};
   ...
   var ChangeUrl = function (a) {
      return {ctor: "ChangeUrl"
             ,_0: a};
   };
   var UpdateSearchInput = function (a) {
      return {ctor: "UpdateSearchInput"
             ,_0: a};
   };
   var NoOp = {ctor: "NoOp"};
...
Elm.Pages.About.make = function (_elm) {
   "use strict";
   _elm.Pages = _elm.Pages || {};
   _elm.Pages.About = _elm.Pages.About || {};
   if (_elm.Pages.About.values)
   return _elm.Pages.About.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.Pages.Data.make = function (_elm) {
   ...
   _elm.Pages.Data.values = {_op: _op
                            ,view: view};
   return _elm.Pages.Data.values;
};
Elm.Pages = Elm.Pages || {};
Elm.Pages.Docs = Elm.Pages.Docs || {};
Elm.Pages.Docs.make = function (_elm) {
   "use strict";
   _elm.Pages = _elm.Pages || {};
   _elm.Pages.Docs = _elm.Pages.Docs || {};
   if (_elm.Pages.Docs.values)
   return _elm.Pages.Docs.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Pages.Docs",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   _elm.Pages.Docs.values = {_op: _op
                            ,view: view};
   return _elm.Pages.Docs.values;
};
Elm.Pages = Elm.Pages || {};
Elm.Pages.Index = Elm.Pages.Index || {};
Elm.Pages.Index.make = function (_elm) {
   "use strict";
   _elm.Pages = _elm.Pages || {};
   _elm.Pages.Index = _elm.Pages.Index || {};
   if (_elm.Pages.Index.values)
   return _elm.Pages.Index.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   _elm.Pages.Index.values = {_op: _op
                             ,view: view};
   return _elm.Pages.Index.values;
};
Elm.Partials = Elm.Partials || {};
Elm.Partials.make = function (_elm) {
   "use strict";
   _elm.Partials = _elm.Partials || {};
   if (_elm.Partials.values)
   return _elm.Partials.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var navigation = F2(function (address,
   model) {
      return A2($Html.nav,
      _L.fromArray([]),
      ...
      _L.fromArray([A2($Html.li,
                   ...
                   address,
                   $Model.ChangeUrl("/docs"))]),
                   _L.fromArray([$Html.text("API Documentation")]))]))
                   ,A2($Html.li,
                   _L.fromArray([]),
                   _L.fromArray([A2($Html.a,
                   _L.fromArray([A2($Html$Events.onClick,
                   address,
                   $Model.ChangeUrl("/data"))]),
                   _L.fromArray([$Html.text("Data & Resources")]))]))
                   ,A2($Html.li,
                   _L.fromArray([]),
                   _L.fromArray([A2($Html.a,
                   _L.fromArray([A2($Html$Events.onClick,
                   address,
                   $Model.ChangeUrl("/about"))]),
                   _L.fromArray([$Html.text("About")]))]))]))]));
   });
   var pageFooter = F2(function (address,
   model) {
      return A2($Html.footer,
      _L.fromArray([$Html$Attributes.$class("page-footer")]),
      _L.fromArray([A2(navigation,
                   address,
                   model)
                   ,A2($Html.p,
                   _L.fromArray([$Html$Attributes.$class("credits")]),
                   _L.fromArray([$Html.text("Created by ")
                                ,A2($Html.a,
                                _L.fromArray([$Html$Attributes.href("https://twitter.com/gelatindesign")]),
                                _L.fromArray([$Html.text("gelatindesign")]))]))
                   ,A2($Html.p,
                   _L.fromArray([$Html$Attributes.$class("credits")]),
                   _L.fromArray([$Html.text("Source available on ")
                                ,A2($Html.a,
                                _L.fromArray([$Html$Attributes.href("https://github.com/lsjroberts/pi-me-a-river")]),
   ...
   _L.fromArray([A2($Html.h1,
                _L.fromArray([]),
                _L.fromArray([$Html.text("Pi Me A River")]))
                ,A2($Html.p,
                _L.fromArray([]),
                _L.fromArray([$Html.text("A look into the data and relationships of the world\'s rivers")]))]));
   _elm.Partials.values = {_op: _op
...
Elm.River = Elm.River || {};
Elm.River.make = function (_elm) {
   "use strict";
   _elm.River = _elm.River || {};
   if (_elm.River.values)
   return _elm.River.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var riverItem = function (river) {
      return A2($Html.article,
      _L.fromArray([$Html$Attributes.$class("river")]),
      _L.fromArray([A2($Html.h2,
                   ...
                   "river/",
                   river.id))]),
                   _L.fromArray([$Html.text(river.name)]))]))
                   ,$Map.river(river)]));
   };
   var riversList = function (rivers) {
      return function () {
         var riverItems = A2($List.map,
         riverItem,
         rivers);
         return A2($Html.section,
         _L.fromArray([$Html$Attributes.$class("rivers-list")]),
         riverItems);
      }();
   };
   var filterRivers = F2(function (term,
   rivers) {
      return function () {
         var isMatching = F2(function (term$,
         river) {
            return $String.contains(term$)($String.toLower(river.name)) || F2(function (x,
            y) {
               return _U.cmp(x,y) < 0;
            })(0)($List.length($List.filter($String.contains(term$))($List.map($String.toLower)(river.countries))));
         });
         return $List.filter(isMatching($String.toLower(term)))(rivers);
      }();
   });
   _elm.River.values = {_op: _op
...
Elm.Router.make = function (_elm) {
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Model = Elm.Model.make(_elm),
   $Pages$About = Elm.Pages.About.make(_elm),
   $Pages$Data = Elm.Pages.Data.make(_elm),
   $Pages$Docs = Elm.Pages.Docs.make(_elm),
   $Pages$Index = Elm.Pages.Index.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var view = F2(function (address,
   model) {
      return function () {
         var view$ = function () {
            ...
            {case "/":
               ...
               case "/data":
               return $Pages$Data.view;
               case "/docs":
               return $Pages$Docs.view;}
            _U.badCase($moduleName,
...
Elm.Search.make = function (_elm) {
   ...
   $Model = Elm.Model.make(_elm),
   $Result = Elm.Result.make(_elm),
   $River = Elm.River.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $Utils = Elm.Utils.make(_elm);
   var searchResults = function (model) {
      return function () {
         var results = $Basics.not($String.isEmpty(model.searchInput)) ? $River.filterRivers(model.searchInput)(model.rivers) : model.rivers;
         return $River.riversList($List.reverse($List.sortBy(function (_) {
            return _.realLength;
         })(results)));
      }();
   };
   var searchForm = F2(function (address,
   model) {
      return function () {
         var showingTitle = _L.fromArray([$Html.text("Showing ")
                                         ,$Html.text($Basics.toString($List.length(A2($River.filterRivers,
                                         model.searchInput,
                                         model.rivers))))
                                         ,$Html.text(" of ")
                                         ,$Html.text($Basics.toString($List.length(model.rivers)))
                                         ,$Html.text(" rivers in the database")]);
         var searchTitle = _L.fromArray([$Html.text("Search the ")
                                        ,$Html.text($Basics.toString($List.length(model.rivers)))
                                        ,$Html.text(" rivers in the database")]);
         var title = $String.isEmpty(model.searchInput) ? searchTitle : showingTitle;
         return A2($Html.form,
         _L.fromArray([$Html$Attributes.$class("search")]),
         _L.fromArray([A2($Html.h2,
                      _L.fromArray([]),
                      title)
                      ,A2($Html.input,
                      _L.fromArray([$Html$Attributes.type$("search")
                                   ,$Html$Attributes.placeholder("e.g. \"Amazon\", \"Brazil\"")
   ...
   var search = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("search")]),
      _L.fromArray([A2(searchForm,
                   address,
                   model)
                   ,searchResults(model)]));
   });
...
Elm.Utils.make = function (_elm) {
   ...
   var last = function (items) {
      return $List.head($List.drop($List.length(items) - 1)(items));
   };
   var join = F2(function (glue,
   items) {
